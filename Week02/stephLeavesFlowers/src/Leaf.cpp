...
void Leaf::setup(){
    ...
    leafColor = ofColor(ofRandom(0,20),ofRandom(100,200),ofRandom(0,20), ofRandom(50,125)); //set to random green color
    
    //ofRandom(150,255));
    scaleFactor = ofRandom(.5,1.0);
    ofSetRectMode(OF_RECTMODE_CENTER);
    stemLength = ofRandom(40,60);
    stemWidth = ofRandom(2,4);
    leafLength = ofRandom(100,350);
    leafWidth = ofRandom(50,170);
...
void Leaf::draw(){
    ...
    ofDrawTriangle(0 - stemWidth/2, 0 - stemLength, 0 + stemWidth/2, 0 - stemLength, 0, 0 - stemLength - 3*(leafLength/4));
